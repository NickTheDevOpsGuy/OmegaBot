 ...
 */
/** Set of valid 5-letter words for guess validation (not just daily answers). */
const WORDS_SET = new Set(WORDS);

/** Returns true if the guess is in the word list (valid Wordle guess). */
export function isWordInList(guess: string): boolean {
  return WORDS_SET.has(guess.toLowerCase());
}
